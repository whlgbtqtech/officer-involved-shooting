...
**TODO**: Officer-Involved-Shooting is the only &hellip; that &hellip;
...
```bash
# clone the repo
git clone git@github.com:yourname/officer-involved-shooting.git

# change dir to the cloned repo
cd officer-involved-shooting
